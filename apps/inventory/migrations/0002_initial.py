...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='issue',
            name='storekeeper',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='issue_as_storekeeper', to='user.user'),
        ),
        migrations.AddField(
            model_name='issue',
            name='items',
        ...
        migrations.AddField(
            model_name='reception',
            name='storekeeper',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reception_as_storekeeper', to='user.user'),
        ),
        migrations.AddField(
            model_name='reception',
            name='recep_doc',
        ...
        migrations.AddField(
            model_name='reservation',
            name='reserved_by',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reservation_as_reserved_by', to='user.user'),
        ),
        migrations.AddField(
            model_name='reservation',
            name='storekeeper',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reservation_as_storekeeper', to='user.user'),
        ),
        migrations.AddField(
